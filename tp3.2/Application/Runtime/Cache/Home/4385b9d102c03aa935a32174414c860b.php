  			...
  			<div class="history">
				<div class="history-date">
					<ul>
						...
						<?php if(is_array($messages)): foreach($messages as $key=>$message): ?><li class="green bounceInDown">
							<h3>
								<img src="/tp32/Public/message/logo100x100.jpg"><?php echo ($message['uname']); ?>
								<span><?php echo (date('Y-m-d H:i:s',$message['created_at'])); ?></span>
								<!-- <span><?php echo date('Y-m-d H:i:s'),$message['created_at'];?></span> -->
									<div class="clr"></div>
							</h3>
							<dl>
								<dt class="hfinfo"><?php echo ($message['content']); ?></dt>
							</dl>
